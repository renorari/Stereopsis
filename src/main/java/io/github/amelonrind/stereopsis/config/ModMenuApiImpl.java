            ...
            return YetAnotherConfigLib.createBuilder()
                    ...
                    .category(ConfigCategory.createBuilder()
                            ...
                            .option(Option.<Integer>createBuilder()
                                    ...
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(translatable("splitInventory"))
                                    .description(descriptionOf("splitInventory"))
                                    .binding(def.splitInventory, () -> cfg.splitInventory, val -> cfg.splitInventory = val)
                                    .controller(TickBoxControllerBuilder::create)
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(translatable("splitOtherUI"))
                                    .description(descriptionOf("splitOtherUI"))
                                    .binding(def.splitOtherUI, () -> cfg.splitOtherUI, val -> cfg.splitOtherUI = val)
                                    .controller(TickBoxControllerBuilder::create)
                                    .build())
                            .build())
